class HomeController < ApplicationController
  def index
      @name = 'Week 3 of Women on Rails!!!'
      @username_1 = 'This is my username_1'
      @username_2 = 'This is my username_2'
      ...
      @my_table = [
        'http://slides.com/women_on_rails/week-1',
        'http://slides.com/women_on_rails/week-2',
        'http://slides.com/women_on_rails/week-3']
